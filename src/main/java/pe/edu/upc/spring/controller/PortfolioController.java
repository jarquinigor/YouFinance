...
public class PortfolioController {
	...
	public String delete(Map<String, Object> model, @RequestParam(value = "idPortfolio") Integer idPortfolio) {
		try {
			if (idPortfolio != null && idPortfolio > 0) {
				pService.delete(idPortfolio);
				model.put("portfolio", new Portfolio());
				model.put("listPortfolios", pService.findAllSortIdAsc());
			}
		} catch (Exception ex) {
	...
	public String portfolio(Map<String, Object> model, @RequestParam(value = "idPortfolio") Integer idPortfolio, HttpSession session) {
